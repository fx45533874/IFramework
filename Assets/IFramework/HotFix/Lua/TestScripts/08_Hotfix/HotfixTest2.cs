...
namespace IFramework.Hotfix.Lua
{
    ...
    public class HotfixTest2 : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.HotfixCalc, 'Add', function(self, a, b)
                return a + b
            end)
        ");
            ...
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.HotfixCalc, 'TestOut', function(self, a, c, go)
        ...
        ");
            ...
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.HotfixCalc, {
                 Test1 = function(self)
                    print('Test1', self)
                    return 1
                 end;
        ...
        ");
            ...
            xlua.hotfix(CS.IFramework.Hotfix.Lua.StatefullTest, {
                ['.ctor'] = function(csobj)
        ...
        ");
            ...
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.GenericClass(CS.System.Double), {
                ['.ctor'] = function(obj, a)
        ...
        ");
            ...
            itt.Foo();
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.InnerTypeTest, 'Bar', function(obj)
                    print('lua Bar', obj)
                    return {x = 10, y = 20}
                end)
        ");
            ...
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.StructTest, 'GetGo', function(self, a, b)
        ...
        ");
            ...
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.GenericStruct(CS.System.Int32), 'GetA', function(self, a)
                    print('GetA',self, a)
                    return 789
                end)
        ");
            ...
            XLuaEnv.DoString(@"
            xlua.hotfix(CS.IFramework.Hotfix.Lua.BaseTest, 'Foo', function(self, p)
                    print('BaseTest', p)
                end)
            xlua.hotfix(CS.IFramework.Hotfix.Lua.BaseTest, 'ToString', function(self)
