...
namespace IFramework.GUITool
{
    ...
    public interface IRectGUI : IGUI { }
    public interface ILayoutGUI : IGUI { }
    public static partial class IGUIEx
    {
        public static T Pan<T>(this T self, Action action) where T : IGUI
        {
            if (action != null)
            {
                action();
